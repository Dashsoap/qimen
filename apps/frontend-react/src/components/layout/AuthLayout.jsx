...
const AuthLayout = ({ 
  ...
  return (
    <div className={`auth-view ${className}`}>
      {/* 背景装饰 */}
      ...
      <div className="auth-container">
        ...
        <div className="header-section">
          <div className="logo-container">
            <div className="logo-symbol">
              <span className="symbol-text">奇</span>
            </div>
          </div>
          <h1 className="app-title">丁未奇门遁甲</h1>
        ...
        <div className="footer-info">
          ...
          <div className="app-info">
            ...
            <span className="company">丁未奇门遁甲</span>
          </div>
        </div>
      </div>
