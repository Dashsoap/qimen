...
export default class Config {
  ...
  static nine_star = ["蓬", "芮", "冲", "辅", "禽", "心", "柱", "任", "英"];
  static eight_door = ["休", "死", "伤", "杜", "中", "开", "惊", "生", "景"];
  static eight_door2 = ["休", "死", "伤", "杜", "开", "惊", "生", "景"];
  static eight_gua = ["坎", "坤", "震", "巽", "中", "乾", "兑", "艮", "离"];
  static eight_gua2 = ["坎", "坤", "震", "巽", "乾", "兑", "艮", "离"];
  static god_dict = {
    阳: ["符", "蛇", "阴", "合", "勾", "雀", "地", "天"],
    阴: ["符", "蛇", "阴", "合", "虎", "玄", "地", "天"],
  };
  ...
  static clockwise_eightgua = ["坎", "艮", "震", "巽", "离", "坤", "兑", "乾"];
  static anti_clockwise_eightgua = this.clockwise_eightgua.slice().reverse();
  static door_r = ["休", "生", "伤", "杜", "景", "死", "惊", "开"];
  static star_r = ["蓬", "任", "冲", "辅", "英", "禽", "柱", "心"];
  ...
  static door_code = {
    阳遁: this.range(1, 9).reduce((obj, cur, index) => {
      obj[cur] = this.eight_door2[index];
      return obj;
    }, {}),
    阴遁: this.range(1, 9).reduce((obj, cur, index) => {
